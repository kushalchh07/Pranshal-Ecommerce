...
import 'package:pranshal_ecommerce/features/home/presentation/screens/payment_confirmation_screen.dart';
...
class FlashSaleProductDetails extends StatefulWidget {
  ...
  @override
  _FlashSaleProductDetailsState createState() =>
      _FlashSaleProductDetailsState();
}
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                ...
                final product = Product(
                  ...
                  productThumbnail: widget.product!.productThumbnail,
                  sellPrice: widget.product!.sellPrice,
                  totalProductCount: widget.product!.totalProductCount,
                );
                _confirmPurchase(
                    product, _quantity, widget.product!.sellPrice * _quantity);
              },
                          ...
                          builder: (context, state) {
                            if (state is ReviewLoading) {
                              ...
                              if (state.reviews.isNotEmpty) {
                                double totalRating = state.reviews.fold(
                                    0, (sum, review) => sum + review.rating);
                                averageRating =
                                    totalRating / state.reviews.length;
                              }
